...
export const createWorkThunk = work => dispatch => {
  axios.post(`${process.env.API_BASE_URL}/api/minions/${work.minionId}/work`, work)
  .then(res => res.data)
  .then(createdWork => {
...
export const updateWorkThunk = work => dispatch => {
  axios.put(`${process.env.API_BASE_URL}/api/minions/${work.minionId}/work/${work.id}`, work)
  .then(res => res.data)
  .then(updatedWork => {
...
export const deleteWorkThunk = work => dispatch => {
  axios.delete(`${process.env.API_BASE_URL}/api/minions/${work.minionId}/work/${work.id}`)
  .then(() => {
